...
$res = $client->request(
    'GET',
    DIRECCION_BASE.'/api/enrollments',
    [ 'headers' => $headers ]
);
  ...
  <div class="starter-template">
    ...
    <table class="table table-sm table-dark">
        ...
        ?>
            ...
            <td><?php echo $value['dateEnrollment']; ?></td>
            <td><?php echo $value['student']['name']; ?></td>
            <td><?php echo $value['program']['name']; ?></td>
            <td><a href="viewEnrollment.php?id=<?php echo $value['id']; ?>"><button type="button" class="btn btn-info">View</button></a><a href="updateEnrollment.php?id=<?php echo $value['id']; ?>"><button type="button" class="btn btn-primary">Edit</button></a><a href="deleteEnrollment.php?id=<?php echo $value['id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
            </tr>
        <?php 
        }
        ?>
