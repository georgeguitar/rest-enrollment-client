  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="dropdownrequire __DIR__ . '/vendor/autoload.php';-item" href="../student/student.php">Student</a>
...
<h1>Enrollment</h1>
  ...
  <div class="form-group">
    ...
    <p><?php echo $data['dateEnrollment']; ?></p>
  </div>
  <div class="form-group">
    <h4>Student</h4>    
    <p><?php echo $data['student']['name']; ?></p>
  </div>
  <div class="form-group">
    <h4>Program</h4>    
    <p><?php echo $data['program']['name']; ?></p>
  </div>
</main><!-- /.container -->
