...
<h1>Update Student</h1>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputSurname" name="inputSurname" value="<?php echo $data['surname']; ?>">
  </div>
  <div class="form-group">
    <label for="inputAddress">Address</label>
    <input type="text" class="form-control" id="inputAddress" name="inputAddress" value="<?php echo $data['address']; ?>">
  </div>
  <div class="form-group">
