  ...
  <div class="starter-template">
    ...
    <table class="table table-sm table-dark">
        ...
        ?>
            ...
            <td><a href="viewStudent.php?id=<?php echo $value['id']; ?>"><button type="button" class="btn btn-info">View</button></a><a href="updateStudent.php?id=<?php echo $value['id']; ?>"><button type="button" class="btn btn-primary">Edit</button></a><a href="deleteStudent.php?id=<?php echo $value['id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
            </tr>
        <?php 
        }
        ?>
